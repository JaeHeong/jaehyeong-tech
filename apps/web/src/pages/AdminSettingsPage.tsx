    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col gap-4 md:gap-8">
        ...
        <div className="flex flex-col gap-1 md:gap-2 pb-3 md:pb-4 border-b border-slate-200 dark:border-slate-800">
          <h1 className="text-xl md:text-3xl font-bold tracking-tight">프로필 설정</h1>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 md:space-y-8">
          ...
          <div className="bg-card-light dark:bg-card-dark rounded-lg md:rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 md:p-8">
            <h2 className="text-base md:text-xl font-bold mb-4 md:mb-6 flex items-center gap-2">
              <span className="material-symbols-outlined text-primary text-[20px] md:text-[24px]">person</span>
              기본 정보
            </h2>
            <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="flex gap-2 md:gap-3">
                      ...
                      {formData.avatar && (
                        <button
                          ...
                          className="px-3 md:px-4 py-1.5 md:py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs md:text-sm font-medium rounded-lg transition-colors border border-slate-200 dark:border-slate-700"
                        >
                          삭제
                        </button>
                      )}
                    </div>
                    <p className="text-[10px] md:text-xs text-slate-500">JPG, GIF or PNG. 최대 1MB.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                ...
                <div>
                  <label htmlFor="title" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                    직업 / 타이틀
                  </label>
                  <input
                    type="text"
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={200}
                  className="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 text-xs md:text-sm focus:border-primary focus:ring-primary/20 transition-shadow py-2 md:py-2.5 min-h-[80px] md:min-h-[100px]"
                />
                <p className="text-[10px] md:text-xs text-slate-500 mt-1 text-right">{formData.bio.length} / 200자</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card-light dark:bg-card-dark rounded-lg md:rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 md:p-8">
            <h2 className="text-base md:text-xl font-bold mb-4 md:mb-6 flex items-center gap-2">
              <span className="material-symbols-outlined text-primary text-[20px] md:text-[24px]">share</span>
              소셜 링크
            </h2>
            <div className="space-y-3 md:space-y-4">
              {/* GitHub */}
              <div>
                <label htmlFor="github" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  GitHub
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg className="w-4 h-4 md:w-5 md:h-5 text-slate-400" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 text-xs md:text-sm pl-9 md:pl-10 focus:border-primary focus:ring-primary/20 transition-shadow py-2 md:py-2.5"
                  />
                </div>
              </div>
              ...
              {/* Old Blog (Tistory) */}
              <div>
                <label htmlFor="twitter" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  구 블로그
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <span className="material-symbols-outlined text-slate-400 text-[16px] md:text-[20px]">history</span>
                  </div>
                  <input
                    type="url"
                    id="twitter"
              ...
              {/* LinkedIn */}
              <div>
                <label htmlFor="linkedin" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  LinkedIn
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              ...
              {/* Website */}
              <div>
                <label htmlFor="website" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                  Website
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <span className="material-symbols-outlined text-slate-400 text-[16px] md:text-[20px]">language</span>
                  </div>
                  <input
                    type="url"
                    id="website"
          ...
          <div className="flex items-center justify-end gap-2 md:gap-4 pt-2 md:pt-4">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="px-4 md:px-6 py-2 md:py-2.5 bg-primary hover:bg-primary/90 text-white text-xs md:text-sm font-bold rounded-lg shadow-lg shadow-primary/25 transition-all active:scale-[0.98] disabled:opacity-50"
            >
              {isSaving ? '저장 중...' : '저장하기'}
            </button>
          </div>
