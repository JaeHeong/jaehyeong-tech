          ...
          <div className="bg-card-light dark:bg-card-dark rounded-xl border border-slate-200 dark:border-slate-800 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">공개됨</p>
              </div>
            </div>
          </div>
          <div className="bg-card-light dark:bg-card-dark rounded-xl border border-slate-200 dark:border-slate-800 p-4">
          ...
          <div className="bg-card-light dark:bg-card-dark rounded-xl border border-slate-200 dark:border-slate-800 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">공지사항</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 text-slate-500">
            ...
            <p>{activeTab === 'NOTICE' ? '공지사항이 없습니다.' : '정적 페이지가 없습니다.'}</p>
            {activeTab === 'NOTICE' ? (
              <button
                onClick={() => openEditModal()}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-card-light dark:bg-card-dark rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 border border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold">페이지 삭제</h3>
            </div>
          ...
          <div className="relative bg-card-light dark:bg-card-dark rounded-xl shadow-2xl p-6 max-w-2xl w-full mx-4 border border-slate-200 dark:border-slate-800 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary"
                  />
                  <span className="text-sm text-slate-700 dark:text-slate-300">바로 공개</span>
                </label>
              </div>
            </div>
            ...
            <div className="flex gap-3 justify-end mt-6 pt-4 border-t border-slate-200 dark:border-slate-800">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-primary hover:bg-primary/90 text-white text-sm font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
