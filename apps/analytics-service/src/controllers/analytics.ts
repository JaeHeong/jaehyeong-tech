...
export async function getDetailedAnalytics(req: Request, res: Response, _next: NextFunction) {
  try {
    const client = getClient();
...
export async function getWeeklyVisitors(_req: Request, res: Response, _next: NextFunction) {
  try {
    const client = getClient();
...
export async function getPageAnalytics(req: Request, res: Response, _next: NextFunction) {
  try {
    const client = getClient();
